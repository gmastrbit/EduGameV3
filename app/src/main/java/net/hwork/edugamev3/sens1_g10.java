...
public class sens1_g10 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID, mSuccessVolume;
    private int error38 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sens1_g10_1);
        // приховує статус бар:
        ...
        Button button44 = (Button) findViewById(R.id.button56);
        button44.setTypeface(typeFace);
        Button button45 = (Button) findViewById(R.id.button57);
    ...
    public void no_sens1_g10(View view){
        // звук:
        playSound(mError);
        ...
        if(error38 >= 3){
            ...
            Intent questionIntent = new Intent(sens1_g10.this, ErrorThreeActivity.class);
    ...
    public void go_sens1_g10_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g10_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView17);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button58);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button59);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_sens1_g10_s(View view){
        // звук:
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g10_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_sens1_g10(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(sens1_g10.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void toMap_g10(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(sens1_g10.this, MapActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }
