...
public class navk2_g1 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID;
    private int error14 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.navk2_g1_1);
        // приховує статус бар:
        ...
        Button button44 = (Button) findViewById(R.id.button148);
        button44.setTypeface(typeFace);
        Button button45 = (Button) findViewById(R.id.button149);
    ...
    public void no_navk2_g1(View view){
        // звук:
        playSound(mError);
        ...
        if(error14 >= 3){
            ...
            Intent questionIntent = new Intent(navk2_g1.this, ErrorThreeActivity.class);
    ...
    public void go_navk2_g1_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.navk2_g1_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView33);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button150);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button151);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_navk2_g1_s(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.navk2_g1_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_navk2_g1(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(navk2_g1.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void go_navk2_g2_1(View view){
        Intent questionIntent = new Intent(navk2_g1.this, navk2_g2.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.right_in, R.anim.left_out);
        finish();
    }
