...
public class sens1_g2 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID;
    private int error30 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sens1_g2_1);
        // скриває верхній бар:
    ...
    public void no_sens1_g2(View view){
        // звук:
        playSound(mError);
        ...
        if(error30 >= 5){
            ...
            Intent questionIntent = new Intent(sens1_g2.this, ErrorActivity.class);
    ...
    public void go_sens1_g2_2(View view){
        setContentView(R.layout.sens1_g2_2);
        // шрифт:
        Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
        TextView textView1 = (TextView) findViewById(R.id.textView45);
        textView1.setTypeface(typeFace);
    }

    public void go_sens1_g2_3(View view){
        // звук:
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g2_3);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void go_sens1_g2_4(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g2_4);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void go_sens1_g2_5(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g2_5);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView2 = (TextView) findViewById(R.id.textView48);
                textView2.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_sens1_g2_s(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g2_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_sens1_g2(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(sens1_g2.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void go_sens1_g3_1(View view){
        // перехід на 2 гру з анімацією:
        Intent questionIntent = new Intent(sens1_g2.this, sens1_g3.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.right_in, R.anim.left_out);
        finish();
    }
