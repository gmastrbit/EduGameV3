...
public class prir1_g3 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID;
    private int error19 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.prir1_g3_1);
    ...
    public void no_prir1_g3(View view){
        // звук:
        playSound(mError);
        ...
        if(error19 >= 3){
            ...
            Intent questionIntent = new Intent(prir1_g3.this, ErrorThreeActivity.class);
    ...
    public void go_prir1_g3_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.prir1_g3_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView105);
                textView1.setTypeface(typeFace);
                Button button80 = (Button) findViewById(R.id.button82);
                button80.setTypeface(typeFace);
                Button button81 = (Button) findViewById(R.id.button83);
                button81.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_prir1_g3_s(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.prir1_g3_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_prir1_g3(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(prir1_g3.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void go_prir1_g4_1(View view){
        // перехід на 2 гру з анімацією:
        Intent questionIntent = new Intent(prir1_g3.this, prir1_g4.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.right_in, R.anim.left_out);
        finish();
    }
