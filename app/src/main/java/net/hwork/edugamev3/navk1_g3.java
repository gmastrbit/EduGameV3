...
public class navk1_g3 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID;
    private int error11 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.navk1_g3_1);
        ...
        Button button44 = (Button) findViewById(R.id.button68);
        button44.setTypeface(typeFace);
        Button button45 = (Button) findViewById(R.id.button69);
    ...
    public void no_navk1_g3(View view){
        // звук:
        playSound(mError);
        ...
        if(error11 >= 3){
            ...
            Intent questionIntent = new Intent(navk1_g3.this, ErrorThreeActivity.class);
    ...
    public void go_navk1_g3_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.navk1_g3_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView81);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button70);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button71);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_navk1_g3_s(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.navk1_g3_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_navk1_g3(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(navk1_g3.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void go_navk1_g4_1(View view){
        // перехід на 12 гру з анімацією:
        Intent questionIntent = new Intent(navk1_g3.this, navk1_g4.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.right_in, R.anim.left_out);
        finish();
    }
