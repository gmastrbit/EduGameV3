...
public class sens1_g6 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID;
    private int error34 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sens1_g6_1);
        // скриває верхній бар:
    ...
    public void no_sens1_g6(View view){
        // звук:
        playSound(mError);
        ...
        if(error34 >= 3){
            ...
            Intent questionIntent = new Intent(sens1_g6.this, ErrorThreeActivity.class);
    ...
    public void go_sens1_g6_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g6_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView66);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button46);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button47);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_sens1_g6_s(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g6_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView4 = (TextView) findViewById(R.id.textView67);
                textView4.setTypeface(typeFace);
            }
        }, 250);
    }

    public void toMain_sens1_g6(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(sens1_g6.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void go_sens1_g7_1(View view){
        // перехід на 2 гру з анімацією:
        Intent questionIntent = new Intent(sens1_g6.this, sens1_g7.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.right_in, R.anim.left_out);
        finish();
    }
