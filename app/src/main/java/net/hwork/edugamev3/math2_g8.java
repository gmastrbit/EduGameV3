...
public class math2_g8 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID, mSuccessVolume;
    private int error8 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.math2_g8_1);
        // приховує статус бар:
        ...
        Button button44 = (Button) findViewById(R.id.button132);
        button44.setTypeface(typeFace);
        Button button45 = (Button) findViewById(R.id.button133);
    ...
    public void no_math2_g8(View view){
        // звук:
        playSound(mError);
        ...
        if(error8 >= 3){
            ...
            Intent questionIntent = new Intent(math2_g8.this, ErrorThreeActivity.class);
    ...
    public void go_math2_g8_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.math2_g8_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView157);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button134);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button135);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_math2_g8_s(View view){
        // звук:
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.math2_g8_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView4 = (TextView) findViewById(R.id.textView158);
                textView4.setTypeface(typeFace);
                TextView textView0 = (TextView) findViewById(R.id.textView159);
                textView0.setTypeface(typeFace);
            }
        }, 250);
    }

    public void toMain_math2_g8(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(math2_g8.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void toMap_g30(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(math2_g8.this, MapActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }
