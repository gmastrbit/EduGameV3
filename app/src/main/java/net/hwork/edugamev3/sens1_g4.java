...
public class sens1_g4 extends AppCompatActivity {

    private SoundPool mSoundPool;
    private AssetManager mAssetManager;
    private int mSuccessGame, mError, mStreamID;
    private int error32 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sens1_g4_1);
        // приховує статус бар:
    ...
    public void no_sens1_g4(View view){
        // звук:
        playSound(mError);
        ...
        if(error32 >= 5){
            ...
            Intent questionIntent = new Intent(sens1_g4.this, ErrorActivity.class);
    ...
    public void go_sens1_g4_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g4_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void go_sens1_g4_3(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g4_3);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView2 = (TextView) findViewById(R.id.textView59);
                textView2.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_sens1_g4_4(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g4_4);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView3 = (TextView) findViewById(R.id.textView60);
                textView3.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_sens1_g4_s(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.sens1_g4_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_sens1_g4(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(sens1_g4.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void go_sens1_g5_1(View view){
        // перехід на 2 гру з анімацією:
        Intent questionIntent = new Intent(sens1_g4.this, sens1_g5.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.right_in, R.anim.left_out);
        finish();
    }
