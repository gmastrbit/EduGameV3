...
public class math2_g1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.math2_g1_1);
        // скриває верхній бар:
        ...
        Button button44 = (Button) findViewById(R.id.button96);
        button44.setTypeface(typeFace);
        Button button45 = (Button) findViewById(R.id.button97);
    ...
    public void no_math2_g1(View view){
        // звук:
        playSound(mError);
        ...
        if(error1 >= 3){
            ...
            Intent questionIntent = new Intent(math2_g1.this, ErrorThreeActivity.class);
    ...
    public void go_math_g1_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.math2_g1_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView125);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button98);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button99);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_math2_g1_s(View view){
        // звук:
        playSound(mSuccessGame);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.math2_g1_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView4 = (TextView) findViewById(R.id.textView126);
                textView4.setTypeface(typeFace);
            }
        }, 250);
    }

    public void toMain_math2_g1(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(math2_g1.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void go_math2_g2_1(View view){
        // перехід на 12 гру з анімацією:
        Intent questionIntent = new Intent(math2_g1.this, math2_g2.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.right_in, R.anim.left_out);
        finish();
    }
