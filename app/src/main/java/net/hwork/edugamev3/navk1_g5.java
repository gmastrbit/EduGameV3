...
public class navk1_g5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navk1_g5_1);
        // приховує статус бар:
        ...
        Button button44 = (Button) findViewById(R.id.button76);
        button44.setTypeface(typeFace);
        Button button45 = (Button) findViewById(R.id.button77);
    ...
    public void no_navk1_g5(View view){
        // звук:
        playSound(mError);
        ...
        if(error13 >= 3){
            ...
            Intent questionIntent = new Intent(navk1_g5.this, ErrorThreeActivity.class);
    ...
    public void go_navk1_g5_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.navk1_g5_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView87);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button78);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button79);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }

    public void go_navk1_g5_s(View view){
        // звук:
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.navk1_g5_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_navk1_g5(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(navk1_g5.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }

    public void toMap_g15(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(navk1_g5.this, MapActivity.class);
        startActivityForResult(questionIntent, 1);
        overridePendingTransition(R.anim.bottom_in, R.anim.top_out);
        finish();
    }
