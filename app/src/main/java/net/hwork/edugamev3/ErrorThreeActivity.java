...
public class ErrorThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.error_three);
        // приховує статус бар:
        ...
        TextView textView1 = (TextView) findViewById(R.id.textView196);
        textView1.setTypeface(typeFace);
    }

    public void showSnackErrorThree(View view) {
        mSnackbar = Snackbar.make(view, "Герой засмучений :(", Snackbar.LENGTH_LONG)
