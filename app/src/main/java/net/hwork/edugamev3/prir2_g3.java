...
public class prir2_g3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.prir2_g3_1);
        ...
        TextView textView = (TextView) findViewById(R.id.textView185);
        textView.setTypeface(typeFace);
        Button button44 = (Button) findViewById(R.id.button172);
        button44.setTypeface(typeFace);
        Button button45 = (Button) findViewById(R.id.button173);
    ...
    public void no_prir2_g3(View view){
        // звук:
        playSound(mError);
        ...
        if(error23 >= 3){
            ...
            Intent questionIntent = new Intent(prir2_g3.this, ErrorThreeActivity.class);
    ...
    public void go_prir2_g3_2(View view){
        // звук
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.prir2_g3_2);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
                TextView textView1 = (TextView) findViewById(R.id.textView186);
                textView1.setTypeface(typeFace);
                Button button44 = (Button) findViewById(R.id.button174);
                button44.setTypeface(typeFace);
                Button button45 = (Button) findViewById(R.id.button175);
                button45.setTypeface(typeFace);
            }
        }, 250);
    }
    ...
    public void go_prir2_g3_s(View view){
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                setContentView(R.layout.prir2_g3_s);
                // шрифт:
                Typeface typeFace = Typeface.createFromAsset(getAssets(), "comic.ttf");
    ...
    public void toMain_prir2_g3(View view){
        // перехід на головну з анімацією:
        Intent questionIntent = new Intent(prir2_g3.this, MainActivity.class);
        startActivityForResult(questionIntent, 1);
